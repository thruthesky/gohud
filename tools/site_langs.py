...
LANGS = [
    ...
    Lang("zh",    "zh",    "zh-Hans", "zh-Hans", "简体中文",            "ltr", True),
    Lang("zh-tw", "zh-tw", "zh-Hant", "zh-Hant", "繁體中文",            "ltr", True),
    Lang("es",    "es",    "es",      "es",      "Español",          "ltr", True),
    Lang("pt",    "pt",    "pt",      "pt",      "Português",        "ltr", True),
    Lang("ru",    "ru",    "ru",      "ru",      "Русский",          "ltr", True),
    Lang("fr",    "fr",    "fr",      "fr",      "Français",         "ltr", True),
    Lang("tr",    "tr",    "tr",      "tr",      "Türkçe",           "ltr", True),
    Lang("pl",    "pl",    "pl",      "pl",      "Polski",           "ltr", True),
    Lang("it",    "it",    "it",      "it",      "Italiano",         "ltr", True),
    Lang("vi",    "vi",    "vi",      "vi",      "Tiếng Việt",       "ltr", True),
    Lang("id",    "id",    "id",      "id",      "Bahasa Indonesia", "ltr", True),
    Lang("uk",    "uk",    "uk",      "uk",      "Українська",       "ltr", True),
    Lang("th",    "th",    "th",      "th",      "ไทย",               "ltr", True),
    Lang("ar",    "ar",    "ar",      "ar",      "العربية",             "rtl", True),
]
