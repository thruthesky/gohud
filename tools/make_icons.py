# -*- coding: utf-8 -*-
"""The gohud default icon set — hand-drawn 24x24 stroke icons. All redistributed under MIT.
Only self-evident geometry is used — circles, lines, rectangles (no path was copied from another icon font).
For reference, an icon can be customized: change the stroke color, the stroke-width, the fill color, the viewBox or the width/height, and add, remove or edit paths."""
import os, sys
...
print("%d icons generated: %s" % (len(ICONS), OUT))
